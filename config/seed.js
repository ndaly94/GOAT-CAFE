...
(async function() {
  ...
  const items = await Item.create([
    ...
    {name: 'Turkey Wrap', emoji: '🌯', category: categories[1], price: 6.95},
    {name: 'Hot Dog Wrap', emoji: '🌯', category: categories[0], price: 3.95},
    {name: 'Crab Wrap', emoji: '🌯', category: categories[3], price: 14.95},
    {name: 'Fried Shrimp Wrap', emoji: '🌯', category: categories[3], price: 13.95},
    {name: 'Whole Lobster Wrap', emoji: '🌯', category: categories[3], price: 25.95},
    {name: 'Taco Wrap', emoji: '🌯', category: categories[0], price: 1.95},
    {name: 'Burrito (Basically a wrap already)', emoji: '🌯', category: categories[4], price: 4.95},
    {name: 'Pizza Wrap', emoji: '🌯', category: categories[2], price: 3.95},
    {name: 'Spaghetti Wrap', emoji: '🌯', category: categories[2], price: 7.95},
    {name: 'Garlic Bread Wrap', emoji: '🌯', category: categories[2], price: 1.95},
    {name: 'French Fry Wrap', emoji: '🌯', category: categories[3], price: 2.95},
